...
export { toBigNum } from './format/adapters/bigNum';
// Type-only, so the root stays the only place that names toBigNum's parameter
// without importing ./format for it.
export type { Decimal } from './format/index';
